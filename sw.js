const CACHE='tesoreria-multi-v3-buttons-json';
const ASSETS=['./','./index.html','./styles.css','./db.js','./pdf.js','./app.js','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png'];
